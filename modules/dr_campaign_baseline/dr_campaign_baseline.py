...
def pre_dr_campaign_baseline_step_access_control_callback(request, lookup=None):
...
def set_hooks(app):
    app.on_pre_GET_dr_campaign_baseline_step += pre_dr_campaign_baseline_step_access_control_callback    
    app.on_pre_DELETE_dr_campaign_baseline_step += pre_dr_campaign_baseline_step_access_control_callback